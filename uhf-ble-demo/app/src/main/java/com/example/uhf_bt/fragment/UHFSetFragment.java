...
//        }
        ...
        } else if(id == R.id.btnGetRFlink) {
            getLinkParams(true);
        } else if(id == R.id.btnSetInventory) {
            setEpcTidUserMode();
        } else if(id == R.id.btnGetInventory) {
            getEpcTidUserMode();
        } else if(id == R.id.rbEPCTIDUSER) {
