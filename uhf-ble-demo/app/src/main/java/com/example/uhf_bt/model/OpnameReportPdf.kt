...
data class OpnameReportPdf(
    ...
    @SerializedName("assro_dt") val assroDt: String?,
    @SerializedName("locations") val locations: List<LocationPdf>?
) : Serializable

data class LocationPdf(
    ...
    @SerializedName("items") val items: List<ItemPdf>?
) : Serializable
